	...
	const getPixelPositionOffset = (width, height) => {
		...
		if (width) {
			return {
				...
				y: 0 // Justo debajo (ajusta este valor para más separación)
			};
		}
		return {
			x: -68, // Centrado horizontalmente
			y: 0 // Justo debajo (ajusta este valor para más separación)
		};
	};
	...
	return (
		<>
			...
			{infoWindowOpen && markerData.infoWindowChildren && (
				<InfoWindow data={markerData.position} infoWindowHandles={infoWindowHandles}>
