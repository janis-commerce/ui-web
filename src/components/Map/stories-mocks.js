...
export const multiRoutesMarkersMock = [
	{
		polylines: [
			{
				lat: -34.59844,
...
export const animatedMarkersMock = [
	{
		polylines: multiRoutesMarkersMock[0].polylines,
		polylineOptions: {
			...multiRoutesMarkersMock[0].polylineOptions,
			strokeColor: 'blue'
		},
		points: [
			{
...
export const markersWithInfoWindow = multiRoutesMarkersMock.map((marker, markerIdx) => {
	return {
		...marker,
